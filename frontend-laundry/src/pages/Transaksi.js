                    ...
                    <div ref={target} id="target">
                        <div className="card-header bg-warning">
                            <h4 className="text-white">
                                Data Transaksi &nbsp;<BsFillMenuButtonWideFill size={25} color="white" />
                            </h4>
                        </div>
                                            ...
                                            <div style={{ display: `none` }}>
                                                <div className="col-lg-12 p-3"
                                                    ...
                                                    <h5 className="text-center">
                                                        Laundry cepat, bersih, wangi, dan trusted. Kami berjanji melayani dengan sepenuh hati
                                                        <br/>
                                                        Telp: 089761435287 | IG: @LaundryCenter
                                                    </h5>
