...
export default class Dashboard extends React.Component {
    ...
    render() {
        return (
            <div className="container bg-primary p-2 bg-opacity-25">
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-success m-1 text-white">
                            <div className="card-body">
                                <a href="/member" ><BsFillPeopleFill size={25} color="white" /></a>
                                <h4 className="card-title">Data Member</h4>
                                <h2>{this.state.jmlMember}</h2>
                                <h6>Daftar member LaundryCenter</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-info m-1 text-white" >
                            <div className="card-body" >
                                <a href="/paket" ><BsInboxesFill size={25} color="white" /></a>
                                <h4 className="card-title">Data Paket</h4>
                                <h2>{this.state.jmlPaket}</h2>
                                <h6>Paket yang tersedia dalam LaundryCenter</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-warning m-1 text-white">
                            <div className="card-body">
                                <a href="/transaksi" ><BsFillMenuButtonWideFill size={25} color="white" /></a>
                    ...
                    <div className="col-lg-6">
                        <div className="card bg-secondary m-1 text-white">
                            <div className="card-body">
